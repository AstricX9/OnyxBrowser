...
class Tab extends EventEmitter {
    ...
    constructor(window, id, appPath, group, theme, options = {}) {
        super();
        ...
        const nodeIntegration = options.nodeIntegration === true;
        ...
        this.view.webContents.on("did-navigate", (event, url, httpResponseCode, httpStatusText) => {
            ...
            if(parsePath(url).protocol === "file") {
                // Special-case internal pages (overlay/settings/about) to keep their own titles/icons
                const clean = url.split("?")[0].split("#")[0];
                if (!(clean.endsWith("/html/overlay.html") || clean.endsWith("/html/settings.html") || clean.endsWith("/html/about.html"))) {
